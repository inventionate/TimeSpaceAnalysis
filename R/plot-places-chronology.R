...
plot_places_chronology <- function(data, id, weekday = "all", size_range = NULL, colour_path = "black", size_path = 2,
  ...
  plot_pc <-
    ...
    theme_void() +
    theme(
      axis.title = element_text(size = 10, family = "Fira Sans Condensed Semibold"),
      axis.text = element_text(size = 8, family = "Fira Sans Condensed Semibold"),
  ...
  plot_time <-
    ...
    theme(
      ...
      axis.text.x.bottom = element_text(family = "Fira Sans Condensed Semibold", face = "bold", size = 12),
      axis.text.y.left = element_text(family = "Fira Sans Condensed Semibold", size = 12),
      legend.text = element_text(family = "Fira Sans Condensed Semibold", size = 12),
      legend.title = element_text(family = "Fira Sans Condensed Semibold", face = "bold", size = 14),
